...
float filter_200hz(float input_value, int filter_number) {
	...
	//A1 = 1
	//A2 = -0.158384440324536
	//B1 = 0.420807779837732
	//B2 = 0.420807779837732
	
	//value_filt[filter_number] = ( (B1*input_value + B2*value_ant1[filter_number] - A1*value_filt_ant1[filter_number]));

	value_filt[filter_number] = ( (0.420807779837732*input_value + 0.420807779837732*value_ant1[filter_number] + 0.158384440324536*value_filt_ant1[filter_number]));
